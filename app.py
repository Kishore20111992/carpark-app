    ...
    with sub_t1:
        ...
        with c_sim2:
            ...
            **How to test on your phone right now:**
            ...
            with c_apk1:
                st.link_button("📥 Release APK (18 MB)", "https://github.com/Kishore20111992/carpark-app/releases/download/v1.0.0/app-release.apk", type="primary", use_container_width=True)
            with c_apk2:
                st.link_button("📥 Debug APK (82 MB)", "https://github.com/Kishore20111992/carpark-app/releases/download/v1.0.0/app-debug.apk", type="secondary", use_container_width=True)
            
            st.markdown("""
            - **Direct GitHub Release**: [View Release v1.0.0 on GitHub](https://github.com/Kishore20111992/carpark-app/releases/tag/v1.0.0)
