    ...
    with sub_t1:
        ...
        with c_sim2:
            ...
            **How to test on your phone right now:**
            ...
            with c_apk1:
                st.link_button("📥 Release APK (v1.0.7)", "https://github.com/Kishore20111992/carpark-app/releases/download/v1.0.7/app-release.apk", type="primary", use_container_width=True)
            with c_apk2:
                st.link_button("📥 Debug APK (v1.0.7)", "https://github.com/Kishore20111992/carpark-app/releases/download/v1.0.7/app-debug.apk", type="secondary", use_container_width=True)
            
            st.markdown("""
            - **Direct GitHub Release**: [View Release v1.0.7 on GitHub](https://github.com/Kishore20111992/carpark-app/releases/tag/v1.0.7)
