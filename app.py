    ...
    with sub_t1:
        ...
        with c_sim2:
            ...
            **How to test on your phone right now:**
            ...
            ##### 📦 Native Flutter APK Compilation:
            The complete Flutter source code is in `mobile_app/`. To compile the `.apk`:
            - **Option A (GitHub Actions Cloud Build)**: Push to GitHub; the automated workflow `.github/workflows/build_apk.yml` builds and gives you the download link in 3 minutes!
